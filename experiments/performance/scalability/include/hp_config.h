...
#define HP_PERFORMANCE_MEASURE_MANAGER                      1
#define HP_PERFORMANCE_MEASURE_SUBFUNCTION_VALIDATING       0
#define HP_PERFORMANCE_MEASURE_SUBFUNCTION_STORING          0
#define HP_PERFORMANCE_MEASURE_SUBFUNCTION_SCHEDULING       0
#endif

#define HP_CONFIG_FREERTOS  1

#define HP_SLOT_COUNT       64
#define HP_CONFIG_LOG       1

#if defined(HP_MEASURE_NUM_HOTPATCHES)
#define HP_APPLICATOR_ENTRY_COUNT   HP_MEASURE_NUM_HOTPATCHES
#else
#define HP_APPLICATOR_ENTRY_COUNT   64
#endif
